    ...
    <div class="yihang border">
      <div class="yihang_div2">
        ...
        <ul class="yihang_div2_li2">
          <li>
            <div class="yihang100 yixuan">已选6条</div>
            <div class="yihang100 fenpeo">一键赢单</div>
            <div class="yihang100 fenpeo">
              <yijiao></yijiao>
            </div>
            <div class="yihang100 fenpeo">协作</div>
            <div class="yihang100 fenpeo">锁定</div>
...
import yijiao from "../biaoge/yijiao.vue";
export default {
  data() {
    return {
      data: [
