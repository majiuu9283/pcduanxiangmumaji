    ...
    <div class="bg1">
      ...
      <div class="form yihang">
        <el-tabs v-model="activeName" @tab-click="handleClick">
          <!--账号密码登陆表单-->
          <el-tab-pane label="账号密码登陆" name="first" class="zhanghu">
            <!--输入账号-->
            ...
            <div class="form_wai">
              {{title2[0]}}(
              <font class="bianse">{{title2[1]}}</font>)
              <img src="../img/4.png" class="img4" />
            </div>
          </el-tab-pane>
          <!--其他登陆方式-->
          <el-tab-pane label="其他登陆方式" name="second" class="zhanghu">
...
export default {
  ...
  created() {
    this.$axios({
      url:
        "https://www.fastmock.site/mock/c306b1c014f14fb7f6c01ef642766d69/_shop_02/api/:id",
      method: "get",
    }).then((res) => {
